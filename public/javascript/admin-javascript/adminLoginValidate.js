...
var rPassword = document.getElementById("admin-password");
var rEmail = document.getElementById("admin-email");
...
function toggleVisibility(){
  var inputPassword = document.getElementById("admin-password")
