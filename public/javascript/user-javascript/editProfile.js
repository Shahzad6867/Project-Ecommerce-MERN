...
let iti = window.intlTelInput(input, {
  utilsScript:
    "https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.8/js/utils.js", // for formatting and validation
  initialCountry: "auto", // or a specific country code like "us"
  geoIpLookup: function (callback) {
    // optional: lookup user's country based on IP
...
iti.setNumber(document.getElementById("phoneNumber").value)
...
document
  ...
  .addEventListener("submit", function (e) {
    ...
    const oldMobileNo = document.getElementById("oldMobileNo").innerText.trim();
