...
//Offer Management
router.get("/offers",adminAuth.checkSession,offerManagementController.getOffers)
router.get("/offers/add-offer",adminAuth.checkSession,offerManagementController.getAddOffer)
router.get("/offers/edit-offer",adminAuth.checkSession,offerManagementController.getEditOffer)
...
//Coupon Management
router.get("/coupons",adminAuth.checkSession,couponManagementController.getCoupons)
router.get("/coupons/add-coupon",adminAuth.checkSession,couponManagementController.getAddCoupon)
...
//Admin Dashboard
router.get("/dashboard",adminAuth.checkSession,dashboardController.getAdminDashboard)
