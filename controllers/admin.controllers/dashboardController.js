...
const getAdminDashboard = async (req, res, next) => {
  try {
    ...
    let totalCustomersCount =
      await dashboardService.computeTotalCustomersCount();
    let grossSales = await dashboardService.computeGrossSales();
    let totalProductDiscount =
      await dashboardService.computeTotalProductDiscount();
    let totalCouponDiscount =
      await dashboardService.computeTotalCouponDiscount();
