...
const getOffers = async(req,res) => {
    ...
    res.render("admin-view/admin.offers.ejs",{message,offers,count,page,pages,timezone})
}
...
const addOffer = async (req,res) => {
   try {
    ...
    const newOffer = await offerService.createNewOffer(offerName,offerType,selectedTarget,selectedTargetVariant,description,startDate,endDate,discountType,discountValue,imageUrl,req.body?.productMinPrice,req.body?.maxDiscountAmount)
...
const editOffer = async (req,res) => {
    try {
        ...
        await offerService.updateOffer(offer._id,offerName,offerType,selectedTarget,selectedTargetVariant,description,startDate,endDate,discountType,discountValue,imageUrl,req.body?.productMinPrice,req.body?.maxDiscountAmount)
